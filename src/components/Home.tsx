...
export function Home({ theme }: HeroProps) {
  ...
  const connectLinks = [
    { img: linkedinLogo, link: "https://www.linkedin.com/in/n-harish-kumar-reddy-8250b5344/" },
    { img: gmailLogo, link: "mailto:nallapareddiharishkumarreddy@gmail.com" },
    { img: whatsappLogo, link: "https://wa.me/+919392387365" },
    { img: instagramLogo, link: "https://www.instagram.com/just_call_me_hari_333/" },
    { img: facebookLogo, link: "https://www.facebook.com/profile.php?id=61579329844383" },
  ];

  const workLinks = [
    { img: githubLogo, link: "https://github.com/Harish1234560" },
    { img: leetcodeLogo, link: "https://leetcode.com/u/Harish4274" },
  ];

  const [typedRoles, setTypedRoles] = useState("");
  const rolesText = "Data Science Engineer | Frontend Developer | Tech Explorer";
    ...
    <section id="home" className="hero">
      ...
      <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
        <motion.h1 className="hero-name" variants={itemVariants}>
          Hi! I’m <br />
          <span className="gradient-text hero-name-line">Harish</span>
        ...
        <motion.div className="hero-info" variants={itemVariants}>
          {[
            { label: "📍 Location", value: "Thamballapalli,AP, India" },
            { label: "💼 Expertise", value: "Programming, Problem Solving" },
            { label: "📞 Contact", value: "nallapareddiharishkumarreddy@gmail.com" },
          ].map((info, i) => (

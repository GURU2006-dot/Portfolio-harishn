...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "nallapareddiharishkumarreddy@gmail.com" },
    { icon: Phone, label: "Phone", value: "+91 9392387365" },
    { icon: MapPin, label: "Location", value: "Thamballapalli,AP, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/Harish1234560" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/n-harish-kumar-reddy-8250b5344/" },
    { icon: Mail, url: "mailto:nallapareddiharishkumarreddy@gmail.com" },
    { icon: MessageCircle, url: "https://wa.me/+919392387365" },
    { icon: Instagram, url: "https://www.instagram.com/just_call_me_hari_333/" },
  ];

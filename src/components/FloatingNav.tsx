...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/Harish1234560', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/n-harish-kumar-reddy-8250b5344/', label: 'LinkedIn' },
    { icon: Twitter, href: '#', label: 'Twitter' },
    { icon: Instagram, href: 'https://www.instagram.com/just_call_me_hari_333/', label: 'Instagram' },
    { 
      icon: () => (
      ...
      href: 'https://leetcode.com/u/Harish4274', 
      label: 'LeetCode' 
    },
    { icon: Mail, href: 'mailto:nallapareddiharishkumarreddy@gmail.com', label: 'Email' },
  ];

    ...
    <section id="about" className="about-wrapper">
        ...
        <div className="about-sticky">
          ...
          >
            <div className="info-inner">
              ...
              <p>
                I’m Harish Kumar Reddy N, a tech-driven learner passionate about building real-world solutions.
              ...
              <p>
              Currently pursuing B.Tech in Data Science (expected 2028), having completed 2 years of study with practical exposure to Machine Learning and Deep Learning projects.
               Proficient in Python, Java and data preprocessing. Seeking internships to develop industry-ready AI and data science skills.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className={`about-hobbies ${hobbiesVisible ? "hobbies-show" : "hobbies-hidden"}`}>
        ...
        <div className="hobby-grid">
          ...
          <div className="hobby">♟️ Playing Chess</div>
